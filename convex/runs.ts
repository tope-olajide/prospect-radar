...
const runStage = v.union(v.literal("intake"), v.literal("interpret"), v.literal("plan"), v.literal("context_check"), v.literal("plan_review"), v.literal("discover"), v.literal("check_in"), v.literal("evaluate"), v.literal("approval"), v.literal("execute"), v.literal("observe"), v.literal("wait"), v.literal("complete"));
...
export async function recordStep(
  ...
  args: {
    ...
    stage: "intake" | "interpret" | "plan" | "context_check" | "plan_review" | "discover" | "check_in" | "evaluate" | "approval" | "execute" | "observe" | "wait" | "complete";
    label: string;
    summary: string;
